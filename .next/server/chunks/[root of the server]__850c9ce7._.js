...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "src", "data", "users.json");
...
async function PUT(req, context) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["writeFile"])(filePath, JSON.stringify(users, null, 2), "utf-8");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__850c9ce7._.js.map